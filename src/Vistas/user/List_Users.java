...
public class List_Users extends javax.swing.JFrame {
    ...
    public List_Users() {
     ...
     private void cargarUsuarios() {
        ...
        model.addColumn("Límites de libros");

        UsuarioDAO usuarioDAO = new UsuarioDAO();
        List<Usuario> usuarios = usuarioDAO.obtenerUsuarios();
        int Control;
        String Rol_Escritos,Estados;
        for (Usuario usuario : usuarios) {
            Control=usuario.getID_ROL();
            if(Control==1){
                Rol_Escritos="Administrador";
            }else if(Control==2){
                Rol_Escritos="Maestro";
            }else if(Control==3){
                Rol_Escritos="Alumno";
            }else{
                Rol_Escritos="Desconocido";
            }
            Control=usuario.getID_ESTADO();
            if(Control==1){
                Estados="Activo";
            }else{
                Estados="Inactivo";
    ...
    private void initComponents() {
        ...
        jButton2.setText("Regresar a usuarios");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jButton2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 248, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        admin_usuarios menu= new admin_usuarios();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(List_Users.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
